...
-- 8b, I would make a bar chart using python to show the top 5 genre for the business.
-- 8c, solution: just delete the query I wrote for top 5 genre to delete the view
